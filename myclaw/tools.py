...
def shell(cmd: str) -> str:
    ...
    try:
        ...
        # Prevent leaking system internals on failure
...
def read_file(path: str) -> str:
    try:
        ...
        # Return generic error to prevent leaking file existence or permissions
        return "Error: Access denied"
...
def write_file(path: str, content: str) -> str:
    try:
        ...
        # Return generic error to prevent leaking file system state
        return "Error: Access denied"
